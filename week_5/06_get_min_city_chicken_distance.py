...
#여러 개 중에서 m개를 고른 뒤, 모든 치킨거리의 합이 가장 작게 되는 경우 반환
# 여러 개중 특정 개수를 뽑는 경우의 수
#모든 경우의 수를 다 구함
#조합 사용 itertools
def get_min_city_chicken_distance(n, m, city_map):
    ...
    chicken_location_m_combinations = list(itertools.combinations(chicken_location_list, m))#조합
